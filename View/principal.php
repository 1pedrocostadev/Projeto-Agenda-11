...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-bar-block w3-center w3-blue ">
        ...
        <a href="#outrasFormacoes" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-greyw3-hover-textcyan w3-text-light-grey">
        ...
        <form action="" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
            ...
            <div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtDescOF" type="text" placeholder="Descrição: Ex.: Curso de Inglês Avançado - Cultura Inglesa">
                    </div>
                </div>
                <div class="w3-row w3-section">
                    <div class="w3-center" style="">
