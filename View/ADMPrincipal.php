...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-large" id="main">
        ...
        <form action="index.php" method="post" class="w3-container w3-light-grey w3-text-blue w3-margin w3-center" style="">
            ...
            <button name="btnListarADM" class="w3-button w3-margin w3-blue w3-cell w3-round-large" style="">
                <br> <i class="fa fa-user-secret w3-xxlarge"></i><br>
                <p class="w3-xlarge">Listar<br> Administradores</p>
            </button>
        </form>
    </div>
</body>
